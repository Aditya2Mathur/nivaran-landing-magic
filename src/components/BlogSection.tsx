    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-up">
          ...
          <p className="text-gray-600">Stay informed with our expert healthcare articles and tips</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogs.map((blog, index) => (
            <div 
              key={blog.title}
              className="rounded-xl overflow-hidden border border-gray-100 hover:border-primary/20 transition-all animate-fade-up"
